...
<div class="user-pic">
<img alt="Profile Image" width="33" height="33" data-src-retina="../images/profiles/{{ $complaint->profile->avatar }}" data-src="../images/profiles/{{ $complaint->profile->avatar }}" src="{{ $complaint->profile->avatar }}">
</div>
...
<h6 class="font-montserrat all-caps hint-text m-t-0">Processing...</h6>
<small class="fs-12 hint-text">{{ $complaint->processingDate->format('j F Y,'.' h:m' . ' A ') }}</small>
</div>
</div>
</div>