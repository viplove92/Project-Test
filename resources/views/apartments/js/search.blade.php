...
$('.typeahead').typeahead([
    {
        ...
        remote: {
            url: 'http://localhost:9200/easymanage/_search?from=0&size=20&q=%QUERY*',
    ...
    },
    {
        ...
        cache: false,
        header: '<h4 class="suggestion-header" align="center">Address<h4>',

        template: [
            '<a href="#"><div>',
            '<p class="geo-name tt-hint">@{{ name}}</p>',
            '<p class="geo-country text-muted tt-hint">@{{ city}} - @{{ pincode}}</p>',
