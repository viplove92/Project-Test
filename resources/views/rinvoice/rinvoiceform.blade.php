...
<div class="col-sm-6">
    ...
    <div class="form-group-attached">
            ...
            <div class="form-group form-group-default">
            {!! Form::label('payee_id', 'Payer : ', ['class' => 'control-label']) !!}
            {!! Form::select('payee_id', $payeeid, null, ['id'=>'group', 'class' => 'full-width']) !!}
            </div>
...
<div class="form-group-attached">
<div class="form-group form-group-default">
            {!! Form::label('tags', 'Tag : ', ['id'=>'tag', 'class' => 'control-label']) !!}
