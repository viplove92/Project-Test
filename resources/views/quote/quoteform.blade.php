<div class="row form-group-attached animated fadeInDown ">
                                                        ...
                                                        <select name="account_id" class="form-control">
                                                            @if ($lists->count())
                                                                @foreach($lists as $list)
                                                                    <option value="{{ $list->id }}"> {{ $list->account }}, {{ $list->address }}, {{ $list->city }}, {{ $list->state }}, {{ $list->zip }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                        ...
                        <main id="app">
                                <table class="table">
                                        ...
                                        <tr v-for="item in items">
                                                <td>@{{$index + 1}}</td>
                                                <td><textarea class="form-control" name="description[]" id="customer_notes"  rows="3" cols="40"></textarea></td>
                                                ...
                                                <td><input name="rowtotal[]" type="text" value="@{{ (item.price * item.quantity).toFixed(2) }}" disable class="form-control"></td>
                                ...
                                <table class="table invoice-total">
                                        ...
                                        <tr>
                                                ...
                                                <td name="subtotal" v-model='subtotal'>@{{ subtotal }}</td>
                                        </tr>

                                        <tr>
                                                <td><strong>Discount :</strong></td>
                                                <td><input id="deposit" name="discount" type="number" step="1" min="0" v-model="deposit" class="form-control" data-a-sign="" data-a-sep="" data-d-group="2"></td>
                                        </tr>

                                        <tr>
                                                <td><strong>Outstation Charges :</strong></td>
                                                <td>
                                                        <input name="oc" type="number" v-model="oc" value="5" min="0" max="99" step="1" class="form-control" style="width:4rem;display:inline">
                                                        @{{ stoc }}
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                        <input name="tax" type="number" v-model="hst" value="13" min="0" max="99" step="1" style="width:4rem;display:inline" class="form-control"> @{{ tax }}
